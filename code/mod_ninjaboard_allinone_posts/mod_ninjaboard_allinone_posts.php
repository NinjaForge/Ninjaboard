...
$document->addStyleSheet( JURI::base(true).'/modules/mod_ninjaboard_allinone_posts/css/mod_ninjaboard_allinone_posts.css', 'text/css' );
...
$module_id = $module->id;
//get list items
$items = modNinjaBoardPostsHelper::getNinjaBoardPosts($params);
//if (!count($items)) return;
//get template
require( JModuleHelper::getLayoutPath( 'mod_ninjaboard_allinone_posts', $layout ) );
?>
