...
$document->addStyleSheet( JURI::base(true).'/modules/mod_ninjaboard_popular_posts/css/mod_ninjaboard_popular_posts.css', 'text/css' );
...
$module_id = $module->id;
//get list items
$items = modNinjaBoardPopularHelper::getNinjaBoardPosts($params);
//if no results return
//if (!count($items)) return;
//get template
require( JModuleHelper::getLayoutPath( 'mod_ninjaboard_popular_posts', $layout ) );
?>
