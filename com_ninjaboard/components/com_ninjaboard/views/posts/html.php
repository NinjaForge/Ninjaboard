...
class ComNinjaboardViewPostsHtml extends ComNinjaboardViewHtml
{
	public function display()
	{
		...
		$this->total	= KFactory::get($this->getModel())->getTotal();
	...
	{
		return '<a class="button" href="'.$this->createRoute('view=post&id='.$id).'"<span class="symbol edit"></span>' . JText::_('Edit post') . '</a>';
	}
}