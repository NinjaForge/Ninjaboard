...
/**
 * Ninjaboard Profile Field List View
 *
 * @package Ninjaboard
 */
	...
	//add ie6 css if needed
		...
		<form action="index.php?option=com_ninjaboard" method="post" name="adminForm">
			...
			<thead>
				<tr>
					...
					<th nowrap="nowrap" width="98%">
						<?php echo JHTML::_('grid.sort', 'NB_NAME', 'l.name', @$lists['filter_order_Dir'], @$lists['filter_order'], 'ninjaboard_profilefieldlist_view'); ?>
					</th>
					<th nowrap="nowrap" width="1%">
						<?php echo JHTML::_('grid.sort', 'NB_PUBLISHED', 'l.published', @$lists['filter_order_Dir'], @$lists['filter_order'], 'ninjaboard_profilefieldlist_view'); ?>
					</th>																													
					<th nowrap="nowrap" width="1%">
						<?php echo JHTML::_('grid.sort', 'NB_ID', 'l.id', @$lists['filter_order_Dir'], @$lists['filter_order'], 'ninjaboard_profilefieldlist_view'); ?>
					</th>			
				</tr>
			</thead>
			<tfoot>
			...
			for ($i=0, $n=count($rows); $i < $n; $i++) {
				...
				$task_published = $row->published ? 'ninjaboard_profilefieldlist_unpublish' : 'ninjaboard_profilefieldlist_publish';
				$alt_published = $row->published ? JText::_('NB_PUBLISHED') :  JText::_('NB_UNPUBLISHED');
								
				$link = 'index.php?option=com_ninjaboard&task=ninjaboard_profilefieldlist_edit&hidemainmenu=1&cid[]='. $row->id;																																		
				?>
			...
			<input type="hidden" name="task" value="ninjaboard_profilefieldlist_view" />
	...
	//add ie6 css if needed
		...
		<script language="javascript" type="text/javascript">
			function submitbutton(pressbutton) {
				...
				if (pressbutton == 'ninjaboard_profilefieldlist_cancel') {
				...
				if (trim(form.name.value) == "") {
					alert("<?php echo JText::sprintf('NB_MSGFIELDREQUIRED', JText::_('NB_NAME'), JText::_('NB_PROFILEFIELDLIST')); ?>");
				} else {
					submitform(pressbutton);
				}
			}
		...
		<form action="index.php" method="post" name="adminForm" id="adminForm">
			<div class="col width-50">
				<fieldset class="adminform">
					<legend>
						<?php echo JText::_('NB_FIELDLISTDETAILS'); ?>
					</legend>
