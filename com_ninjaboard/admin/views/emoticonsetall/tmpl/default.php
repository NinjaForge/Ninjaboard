...
defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	JToolBarHelper::title(JText::_('NB_EMOTICONSETMANAGER'), 'ninjahdr');
...
?>
		<div id="submenu-box2">
			...
			<ul id="submenu2">
				...
				<li>
					<a class="active" href="index.php?option=com_ninjaboard&task=display&controller=emoticonset"><?php echo JText::_('NB_EMOTICONSETS'); ?></a>
				</li>
				<li>
		...
		<form id="Uploadfiles" name="Uploadfiles" action="index.php" enctype="multipart/form-data" method="post">
		  ...
		  <input type="hidden" name="task" value="uploademoticonset" />
		...
		<form action="index.php?option=com_ninjaboard" method="post" name="adminForm">
			...
			for ($i=0, $n=count($this->rows); $i < $n; $i++) {
				...
				$link = 'index.php?option=com_ninjaboard&task=edit&controller=emoticonset&cid[]='. $row->file_name .'&hidemainmenu=1';																																		
				?>
