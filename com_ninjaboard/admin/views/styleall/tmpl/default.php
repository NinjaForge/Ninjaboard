...
defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	JToolBarHelper::title(JText::_('NB_STYLEMANAGER'), 'ninjahdr');
...
?>
		...
		<div id="submenu-box2">
			...
			<ul id="submenu2">
				...
				<li>
					<a class="active" href="index.php?option=com_ninjaboard&task=display&controller=style"><?php echo JText::_('NB_STYLES'); ?></a>
				</li>					
				<!--<li>
		...
		<form id="Uploadfiles" name="Uploadfiles" action="index.php" enctype="multipart/form-data" method="post">
		  ...
		  <input type="hidden" name="task" value="uploadstyle" />
		...
		<form action="index.php?option=com_ninjaboard" method="post" name="adminForm">
			...
			for ($i=0, $n=count($this->rows); $i < $n; $i++) {
				...
				$img_default = $row->default_style ? NB_ADMINIMAGES_LIVE.DL.'menu'.DL.'icon-16-default.png' : NB_ADMINIMAGES_LIVE.DL.'menu'.DL.'spacer.png';
				$alt_default = $row->default_style ? JText::_('NB_DEFAULT') :  JText::_('NB_NOTDEFAULT');				
								
				$link = 'index.php?option=com_ninjaboard&task=edit&controller=style&cid[]='. $row->file_name .'&hidemainmenu=1';																																		
				?>
