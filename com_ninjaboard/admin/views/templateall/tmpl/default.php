<?php defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	JToolBarHelper::title(JText::_('NB_TEMPLATEMANAGER'), 'ninjahdr');
	...
	JToolBarHelper::deleteList(JText::_('Are you sure you want to delete these templates').'?', 'removetemplate');
...
?>
		<div id="submenu-box2">
			...
			<ul id="submenu2">
				...
				<li>
					<a class="active" href="index.php?option=com_ninjaboard&task=display&controller=template"><?php echo JText::_('NB_TEMPLATES'); ?></a>
				</li>
				<li>
		...
		<form action="index.php?option=com_ninjaboard" method="post" name="adminForm">
			...
			for ($i=0, $n=count($this->rows); $i < $n; $i++) {
				...
				$link = 'index.php?option=com_ninjaboard&task=edit&controller=template&cid[]='. $row->file_name .'&hidemainmenu=1';																																	
				?>
