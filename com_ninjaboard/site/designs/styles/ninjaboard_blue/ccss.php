...
/*
 * File:        c-css.php
 * CVS:         $Id: ccss.php 959 2010-09-21 14:33:17Z stian $
...
class ccss implements ifCcss
{
	...
	public $aCssFiles = array(
		'./conditional.css', './font-size.1.0.css',
		'./colors.css', 'jcarousel-skin-nfnb.css'
	);
	 ...
	 * Scope:    ConditionalCSS.CCss - public
	 */
	public $sAuthor = /* ___AUTHOR___ */  "The NinjaForge Team";
	 ...
	 * Scope:    ConditionalCSS.CCss - public
	 */
	public $sCopyright = /* ___COPYRIGHT___ */ "2009 Ninja Media Group";
	...
	public function fnSetUserBrowser ()
	{
		...
		// uwalter: Added Webkit (Chrome)
		else if ( preg_match( '/mozilla.*applewebkit.*chrome\/([0-9a-z\+\-\.]+).*/si', $this->sUserAgent, $aUserAgent ) )
		{
			$this->sUserBrowser = "Chrome";
			$this->sUserVersion = $aUserAgent[1];
		}
